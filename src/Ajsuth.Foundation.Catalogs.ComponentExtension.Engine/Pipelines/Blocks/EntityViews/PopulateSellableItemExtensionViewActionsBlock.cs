// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PopulateSellableItemExtensionViewActionsBlock.cs" company="Sitecore Corporation">
...
{
    /// <summary>Defines the synchronous executing PopulateSellableItemExtensionViewActions pipeline block</summary>
    /// <seealso cref="SyncPipelineBlock{TInput, TOutput, TContext}" />
    [PipelineDisplayName(ComponentExtensionConstants.Pipelines.Blocks.PopulateSellableItemExtensionViewActions)]
