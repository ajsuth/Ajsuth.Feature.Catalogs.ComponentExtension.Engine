// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PopulateVariationExtensionViewActionsBlock.cs" company="Sitecore Corporation">
...
{
    /// <summary>Defines the synchronous executing PopulateVariationExtensionViewActions pipeline block</summary>
    /// <seealso cref="SyncPipelineBlock{TInput, TOutput, TContext}" />
    [PipelineDisplayName(ComponentExtensionConstants.Pipelines.Blocks.PopulateVariationExtensionViewActions)]
