// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetVariationExtensionViewBlock.cs" company="Sitecore Corporation">
...
{
    /// <summary>Defines the synchronous executing GetVariationExtensionView pipeline block</summary>
    /// <seealso cref="SyncPipelineBlock{TInput, TOutput, TContext}" />
    [PipelineDisplayName(ComponentExtensionConstants.Pipelines.Blocks.GetVariationExtensionView)]
