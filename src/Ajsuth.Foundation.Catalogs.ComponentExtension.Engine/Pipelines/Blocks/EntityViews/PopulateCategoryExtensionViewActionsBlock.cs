// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PopulateCategoryExtensionViewActionsBlock.cs" company="Sitecore Corporation">
...
{
    /// <summary>Defines the synchronous executing PopulateCategoryExtensionViewActions pipeline block</summary>
    /// <seealso cref="SyncPipelineBlock{TInput, TOutput, TContext}" />
    [PipelineDisplayName(ComponentExtensionConstants.Pipelines.Blocks.PopulateCategoryExtensionViewActions)]
    public class PopulateCategoryExtensionViewActionsBlock : SyncPipelineBlock<EntityView, EntityView, CommercePipelineExecutionContext>
    {
