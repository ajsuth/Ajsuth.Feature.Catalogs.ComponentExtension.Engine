// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetSellableItemExtensionViewBlock.cs" company="Sitecore Corporation">
...
{
    /// <summary>Defines the synchronous executing GetSellableItemExtensionView pipeline block</summary>
    /// <seealso cref="SyncPipelineBlock{TInput, TOutput, TContext}" />
    [PipelineDisplayName(ComponentExtensionConstants.Pipelines.Blocks.GetSellableItemExtensionView)]
